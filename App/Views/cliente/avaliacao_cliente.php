...
<div class="container d-flex justify-content-center mt-5">
    <div class="card text-center mb-5">
        ...
        <div class="location mt-4">
            <span class="d-block"><i class="fa fa-map-marker start"></i> <small class="text-truncate ml-2">Ganesha Road,
                    preet vihar new delhi</small> </span>
            <span><i class="fa fa-map-marker stop mt-2"></i> <small class="text-truncate ml-2">Mandir Road, Mayur vihar,
                    new delhi</small> </span>
        </div>
        <div class="rate bg-success py-3 text-white mt-3">
            <h6 class="mb-0">Avalie seu profissional</h6>
            <form action="/cliente/avaliou" method="post">
                ...
                <input type="textarea" name="comentario" placeholder="Deixe seu comentário" class="form-control mt-2"
                    required>
...
<div class="card text-center mb-5">
    ...
    <div class="rate bg-success py-3 text-white mt-3">
        ...
        <form action="" method="">
            ...
            <input type="textarea" name="comentario" placeholder="Deixe seu comentário" class="form-control mt-2" required>
            <div class="buttons px-4 mt-0">
                <button type="submit" class="btn btn-warning btn-block rating-submit">Submit</button>
            </div>
        </form>
