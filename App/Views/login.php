      ...
      <div class="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
        <div
          ...
          <form class="space-y-4" action='/iniciarsessao' method='post'>
            ...
            <p class="text-sm !mt-8 text-center text-gray-800">Não possui um cadastro? <a href="/cadastro"
                class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Cadastre-se aqui</a></p>
          </form>
        </div>
        </form>
        <div class="lg:h-[400px] md:h-[300px] max-md:mt-8">
          <img class="space-y-3" src="assets/img/login-image.webp"
